...
export const CreateStrategyBody = zod.object({
  ...
  "riskSnapshot": zod.record(zod.string(), zod.unknown()).nullish(),
...
export const ListStrategyVersionsResponseItem = zod.object({
  ...
  "timeframes": zod.array(zod.string()),
  "riskManagementRules": zod.string().nullable(),
  "riskSnapshot": zod.record(zod.string(), zod.unknown()).nullable(),
  "resetRules": zod.string().nullable(),
  "alertRules": zod.string().nullable(),
  "conditionCount": zod.number().int(),
  "tradeCount": zod.number().int(),
...
export const ListStrategyVersionConditionsResponseItem = zod.object({
  ...
  "canonicalState": zod.record(zod.string(), zod.unknown()).nullable(),
  "stage": zod.enum(['entry', 'confirmation', 'invalidation', 'exit']),
  "name": zod.string(),
  "description": zod.string().nullable(),
  "timeframe": zod.string(),
...
export const ListConceptsResponseItem = zod.object({
  ...
  "canonicalId": zod.string().nullable(),
  "registryVersion": zod.string().nullable(),
  "canonicalStatus": zod.union([zod.literal('executable'),zod.literal('review_required'),zod.literal(null)]).nullable(),
  "executorKind": zod.string().nullable(),
...
export const ListMarketDataSourcesResponseItem = zod.object({
  ...
  "sourceType": zod.enum(['rest', 'websocket', 'historical', 'file', 'other']),
  "description": zod.string().nullable(),
...
export const UpdateMarketDataSourceBody = zod.object({
  "name": zod.string().min(1).optional(),
  "providerKey": zod.string().nullish(),
  "sourceType": zod.enum(['rest', 'websocket', 'historical', 'file', 'other']).optional(),
  "description": zod.string().nullish(),
  "capabilities": zod.array(zod.enum(['realtime', 'candles', 'historical', 'sessions'])).optional(),
  "configurationStatus": zod.enum(['not_configured', 'configured', 'disabled']).optional(),
  "isEnabled": zod.boolean().optional()
...
export const ListAlertsResponseItem = zod.object({
  ...
  "transitionEventId": zod.number().int().nullable(),
  "conditionId": zod.number().int().nullable(),
  "timeframeId": zod.number().int().nullable(),
  "timeframeCode": zod.string().nullable(),
  "direction": zod.string().nullable(),
  "reasonCode": zod.string().nullable(),
  "reason": zod.string().nullable(),
  "evidence": zod.record(zod.string(), zod.unknown()).nullable(),
  "triggeringCandleOpenTime": zod.coerce.date().nullable(),
